...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [self.v_eleme_Back setBackgroundColor:[UIColor colorWithHexString:@"7A8B9F"]];
        ...
        [self.v_meituan_Back setBackgroundColor:[UIColor whiteColor]];
        ...
        [self.lab_meituan_title setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.lab_meituan_zhouqi setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.img_meituan_line1 setBackgroundColor:[UIColor colorWithHexString:@"#9B9B9B"]];
        ...
        [self.img_meituan_line2 setBackgroundColor:[UIColor colorWithHexString:@"#9B9B9B"]];
        ...
        [self.lab_meituan_balance setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.lab_meituan_balanceT setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.lab_meituan_jiesuan setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.lab_meituan_jiesuanT setTextColor:[UIColor colorWithHexString:@"#4A4A4A"]];
        ...
        [self.btn_meituan_tixian setTitleColor:[UIColor colorWithHexString:@"#4A4A4A"] forState:UIControlStateNormal];
        ...
        self.btn_meituan_tixian.layer.borderColor = [[UIColor colorWithHexString:@"#4A4A4A"] CGColor];
        ...
        [self.btn_meituan_mingxi setTitleColor:[UIColor colorWithHexString:@"#4A4A4A"] forState:UIControlStateNormal];
        ...
        self.btn_meituan_mingxi.layer.borderColor = [[UIColor colorWithHexString:@"#4A4A4A"] CGColor];
