//
//  SelectSecondMarerialsViewController.m
//  GouKuRepast
//
...
@interface SelectSecondMarerialsViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,BaseTableViewDelagate>
...
@implementation SelectSecondMarerialsViewController
...
- (void)tableView:(BaseTableView *)tableView requestDataSourceWithPageNum:(NSInteger)pageNum complete:(DataCompleteBlock)complete{
    if (tableView == self.tb_marerialsCatagory) {
        [RepastCommodityHandler getSecondMaterialCategoryWithPage:(int)pageNum materialId:self.marerialsId prepare:^{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.tb_marerialsCatagory) {
        ...
        SelectMarerialsThreeViewController *vc = [[SelectMarerialsThreeViewController alloc]init];
        ...
        for (NSUInteger index = arr_vc.count - 1; arr_vc >= 0; index--) {
            ...
            if (![vc isKindOfClass:[SelectSecondMarerialsViewController class]] && ![vc isKindOfClass:[SelectMarerialsViewController class]]) {
